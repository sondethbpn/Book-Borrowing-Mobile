...
class HistoryLec extends StatelessWidget {
...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Future<void> fetchBorrowHistory() async {
    ...
    final response = await http.get(
      Uri.parse('http://192.168.1.189:3000/history/lecturer'),
      headers: {
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Borrower: ${book['borrower_name'] ?? 'N/A'}',
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontFamily: 'Actor',
                                          ),
                                        ...
                                        Text(
                                          'Got back by: ${book['got_back_by_name'] ?? 'N/A'}',
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontFamily: 'Actor',
                                          ),
