...
import 'package:app/Admin/To_Edit.dart';
...
class BrowseStaff extends StatelessWidget {
  ...
  Future<void> fetchBorrowedData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.1.189:3000/total/details'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          waitingreturn = data['Waiting_return'] ?? 0;
          waitingapproved = data['Waiting_approve'] ?? 0;
          isLoading = false;
        });
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          data = [
            ...
            'Total Aprroved', // Add appropriate data here
            'Waiting Return', // Add appropriate data here
            'Waiting Aprroves', // Add appropriate data here
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFFA50B0E),
                  padding:
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final bool isAvailable =
                  book['status'] == 'Available' || book['status'] == 'Disabled';
                          ...
                          child: book['image'] != null &&
                              ...
                              ? Image.network(
                                  ...
                                  errorBuilder: (context, error, stackTrace) {
                                    // Fallback to a placeholder if network image fails to load
                                    return Image.asset(
...
class DisplayBookImage extends StatelessWidget {
  final String base64Image; // Pass the base64 image string here

  const DisplayBookImage({required this.base64Image});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Book Image")),
      body: Center(
        child: Image.memory(
          decodedBytes,
          fit: BoxFit.cover,
